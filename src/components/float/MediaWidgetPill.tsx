...
export const MediaWidgetPill: React.FC<Props> = ({ media, sessionCount = 1 }) => {
  ...
  return (
    <motion.div className="media-widget-pill">
      {media.albumArtBase64 ? (
        <motion.div layoutId="media-art" className="media-pill-art-container">
          <img 
        ...
        <motion.div layoutId="media-art" className="media-pill-art-container fallback">
          🎵
        </motion.div>
      )}
